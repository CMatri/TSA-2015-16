...
public class SimpleSSAO extends Filter {
...
// Distance falloff
     ...
     * Create a Screen Space Ambient Occlusion Filter
     *
     * @param sampleRadius The radius of the area where random samples will be
     * picked. default 5.1f
     ...
     * @param bias the width of the occlusion cone considered by the occludee.
     * default 0.1f
     */
    public SimpleSSAO(float sampleRadius, float intensity, float scale, float bias) {
        this();
...
//ssao Pass
    ...
    /**
     * Enables fine detail pass for help in blending out artifacting in the
     * wider area pass without losing detail
     *
     * @param useDetailPass
     */
    ...
    /**
     * Sets the the width of the wide area occlusion cone considered by the
     * occludee default is 0.025f
     *
     * @param bias
     */
    ...
    /**
     * Sets the the width of the fine detail occlusion cone considered by the
     * occludee default is 0.025f
     *
     * @param biasFD
     */
    ...
    /**
     * Sets the radius of the area where random samples will be picked dafault
     * 3.0f
     *
     * @param sampleRadius
     */
    ...
    /**
     * Sets the radius of the area where random samples will be picked for fine
     * detail pass dafault 0.55f
     *
    ...
    /**
     *
     * Returns the distance between detail pass occluders and occludee. default
     * 1.55f
     *
     * @param scaleFD
     */
    ...
    /**
     * Sets the rate at which distance falloff increases past the start
     * distance. Default is 2.0f
     *
     * @param falloffRate
     */
    ...
    /**
     * Returns the rate at which distance falloff increases past the start
     * distance.
     *
     * @return falloffRate
     */
    ...
    /**
     * Used for debugging. toggles between shadowmap, colormap &
     * colormap+shadowmap
     */
    ...
    /**
     * Used for debugging. toggles between no smoothing, 1 pass smoothing & 2
     * pass smoothing
     */
